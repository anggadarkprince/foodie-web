                ...
                <div class="px-2 md:w-2/3">
                    <div class="sm:flex -mx-2">
                        <div class="px-2 lg:w-5/12">
                            <div class="flex flex-wrap mb-3 sm:mb-4">
                                ...
                                <input id="app-title" type="text" class="form-input @error('app-title') border-red-500 @enderror"
                                       name="app-title" value="{{ old('app-title', \App\Models\Setting::item(\App\Models\Setting::APP_TITLE, config('app.name'))) }}" required placeholder="Application public name">
                        ...
                        <div class="px-2 lg:w-7/12">
                            <div class="flex flex-wrap mb-3 sm:mb-4">
                                ...
                                <input id="app-tagline" type="text" class="form-input @error('app-tagline') border-red-500 @enderror" name="app-tagline"
                                       value="{{ old('app-tagline', \App\Models\Setting::item(\App\Models\Setting::APP_TAGLINE)) }}" required placeholder="Explain what this site is about">
                    ...
                    <div class="flex flex-wrap mb-3 sm:mb-4">
                        ...
                        <textarea id="app-description" class="form-input @error('app-description') border-red-500 @enderror" name="app-description"
                                  required placeholder="Describe about the site">{{ old('app-description', \App\Models\Setting::item(\App\Models\Setting::APP_DESCRIPTION)) }}</textarea>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="app-keywords" type="text" class="form-input @error('app-keywords') border-red-500 @enderror" name="app-keywords"
                               value="{{ old('app-keywords', \App\Models\Setting::item(\App\Models\Setting::APP_KEYWORDS)) }}" required placeholder="Keyword about the site">
                        ...
                        <div class="relative w-full">
                            <select class="form-input pr-8" name="app-language" id="app-language">
                                ...
                                @foreach($supportedLanguages as $lang => $language)
                                    <option value="{{ $lang }}"{{ old('app-language', \App\Models\Setting::item(\App\Models\Setting::APP_LANGUAGE, 'en')) == $lang ? ' selected' : '' }}>
        ...
        <div class="bg-white rounded shadow-sm px-6 py-4 mb-4">
            <div class="sm:flex -mx-2">
                <div class="px-2 md:w-1/4">
                    ...
                    <span class="text-gray-400 block mb-3">Default group permission</span>
                </div>
                <div class="px-2 md:w-2/3">
                    <div class="flex flex-wrap mb-2">
                        <label for="default-management-group" class="form-label mb-2">{{ __('Default Group') }}</label>
                        <div class="w-full mb-3">
                            <label class="items-center text-gray-700 mt-2" for="management-registration">
                                <input type="checkbox" name="management-registration" id="management-registration" class="form-checkbox"
                                    {{ old('management-registration', \App\Models\Setting::item(\App\Models\Setting::MANAGEMENT_REGISTRATION)) ? 'checked' : '' }}>
                        ...
                        <div class="relative w-full">
                            <select class="form-input pr-8" name="default-management-group" id="default-management-group">
                                @foreach($groups as $group)
                                    <option value="{{ $group->id }}"{{ old('default-management-group', \App\Models\Setting::item(\App\Models\Setting::DEFAULT_MANAGEMENT_GROUP)) == $group->id ? ' selected' : '' }}>
                                        {{ $group->group }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="px-2 sm:w-1/2">
                            <div class="flex flex-wrap mb-3 sm:mb-4">
                                ...
                                <input id="email-support" type="email" class="form-input @error('email-support') border-red-500 @enderror"
                                       placeholder="Email for contact support" name="email-support" value="{{ old('email-support', \App\Models\Setting::item(\App\Models\Setting::EMAIL_SUPPORT)) }}">
                        ...
                        <div class="px-2 sm:w-1/2">
                            <div class="flex flex-wrap mb-3 sm:mb-4">
                                ...
                                <input id="email-bug-report" type="email" class="form-input @error('email-bug-report') border-red-500 @enderror"
                                       placeholder="Email for bug report" name="email-bug-report" value="{{ old('email-bug-report', \App\Models\Setting::item(\App\Models\Setting::EMAIL_BUG_REPORT)) }}">
                    ...
                    <div class="flex flex-wrap mb-3 sm:mb-4">
                        <label class="inline-flex items-center text-gray-700 mt-2" for="maintenance-frontend">
                            <input type="checkbox" name="maintenance-frontend" id="maintenance-frontend" class="form-checkbox"
                                {{ old('maintenance-frontend', \App\Models\Setting::item(\App\Models\Setting::MAINTENANCE_FRONTEND)) ? 'checked' : '' }}>
