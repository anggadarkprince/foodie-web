...
@section('content')
    <form action="{{ route('admin.restaurants.update', ['restaurant' => $restaurant->id]) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded shadow-sm px-6 py-4 mb-4">
            <div class="mb-2">
                <h1 class="text-xl">Edit Restaurants</h1>
            ...
            <div class="pt-2">
                    ...
                    <div class="px-2 sm:w-1/2">
                        <div class="flex flex-wrap mb-3 sm:mb-4">
                            ...
                            <input id="name" type="text" class="form-input @error('name') border-red-500 @enderror"
                                   placeholder="Restaurant name" name="name" value="{{ old('name', $restaurant->name) }}">
                ...
                <div class="flex flex-wrap mb-3 sm:mb-4">
                    ...
                    <textarea id="address" type="text" class="form-input @error('address') border-red-500 @enderror"
                              placeholder="Restaurant address" name="address">{{ old('address', $restaurant->address) }}</textarea>
